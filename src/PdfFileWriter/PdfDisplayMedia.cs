...
namespace PdfFileWriter
{
    ...
    /// </summary>
    internal enum TempFilePermission
    {
        /// <summary>
    ...
    /// </summary>
    internal class PdfDisplayMedia : PdfObject
    {
        /// <summary>
