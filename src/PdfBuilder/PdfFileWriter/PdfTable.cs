...
namespace PdfFileWriter
{
    ...
    ///	</remarks>
    internal delegate void PdfTableStart(PdfTable Table, double TableStartPos);
    ...
    ///	</remarks>
    internal delegate void PdfTableEnd(PdfTable Table, double TableEndPos);
    ...
    /// </remarks>
    internal delegate bool PdfTableCustomDrawCell(PdfTable Table, PdfTableCell Cell);
